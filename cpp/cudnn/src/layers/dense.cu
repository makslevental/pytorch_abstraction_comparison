...
void Dense::bwd_initialize(Tensor<double> *grad_of_output) {
...
Tensor<double> *Dense::backward(Tensor<double> *grad_of_output) {
    ...
    if (DEBUG_DENSE & 0x02) {
        ...
        grad_of_output->print(name_ + "::gradients", true, grad_of_output->get_batch_size());
