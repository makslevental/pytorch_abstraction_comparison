...
#ifndef PYTORCH_ABSTRACTION_TRANSFORM_H
#define PYTORCH_ABSTRACTION_TRANSFORM_H
...
namespace transform {
    ...
    public:
        ...
        explicit ConstantPad(std::vector<int64_t> padding, torch::Scalar value = 0);
    ...
    public:
        ...
        explicit RandomCrop(std::vector<int64_t> size);
        torch::Tensor operator()(torch::Tensor input) override;
...
#endif // PYTORCH_ABSTRACTION_TRANSFORM_H
