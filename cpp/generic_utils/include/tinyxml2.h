...
namespace tinyxml2 {
    ...
    public:
        ...
        */
        ...
        /** Accept a hierarchical visit of the nodes in the TinyXML-2 DOM. Every node in the
                ...
                the XML for the callbacks, so the performance of TinyXML-2 is unchanged by using
           this interface versus any other.)
    ...
    */
    ...
    private:
        ...
        void PrintString(
            const char *, bool restrictedEntitySet); // prints out, after detecting entities.
