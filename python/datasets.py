...
from torchvision.datasets import FashionMNIST, STL10, VOCDetection, MNIST, CIFAR10
...
cifar_10_train = CIFAR10("../data", train=True, download=True)
cifar_10_test = CIFAR10("../data", train=False, download=True)
