...
\begin{adjustbox}{width=0.8\textwidth}
  ...
  \begin{tikzpicture}[%
    ...
    \node[] (node) at (1.3,0) {\Large PyTorch};
    \node[] (node) at (4.5,-2) {\Large LibTorch};
    \node[] (node) at (6.5,-7.2) {\Large cuDNN};
    \node[] (node) at (9.5,-5) {\Large TorchScript};
    \node[] (node) at (0,0) {}
    child[] { node[calls,uncommoncode] { \code{call\_function} } edge from parent[draw=none]
    ...
    \draw[thick,|<->|]
    (0.25,-2) -- (0.25,-4) node [midway, fill=white] {30 calls};
    \draw[thick,|<->|]
    (2,-6) -- (2,-8) node [midway, fill=white] {61 calls};
    \draw[thick,|<->|]
    (10.8,-7) -- (10.8,-9) node [midway, fill=white] {14 calls};
  \end{tikzpicture}
\end{adjustbox}
